...
export const attachmentService = {
    async downloadAttachment(attachmentId: string | number, userId: string): Promise<Blob> {
    ...
    async getPreviewUrl(attachmentId: string | number, userId: string): Promise<string> {
