...
interface NotificationContextType {
    ...
    addToast: (message: string, taskId?: string | number, type?: 'success' | 'error' | 'info') => void;
}
...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({ children }) => {
    ...
    const addToast = useCallback((message: string, taskId?: string | number, type: 'success' | 'error' | 'info' = 'info') => {
        if (isUnmountedRef.current) return;
