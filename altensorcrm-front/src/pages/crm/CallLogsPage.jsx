...
const CallLogsPage = () => {
  ...
  const handleFullCreateCallSubmit = async (e) => {
    e.preventDefault();
  ...
  const handleCreateCallSubmit = handleFullCreateCallSubmit;
  ...
  return (
    <div className="space-y-4 max-w-[1600px] mx-auto text-[#D4D4D8] font-sans selection:bg-fuchsia-500/30 relative min-h-[calc(100vh-80px)]">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-[#2C2C2E]/60 p-4 sm:p-6 shrink-0 bg-[#1C1C1E]">
              <h2 className="text-base sm:text-lg font-bold text-white tracking-tight">{t('callLogs.createCallLog', {}, 'Create Call Log')}</h2>
            ...
            <form onSubmit={handleFullCreateCallSubmit} className="flex flex-col flex-1 min-h-0">
      ...
      {selectedCallDetail && (
        <div 
          className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 backdrop-blur-sm p-2 sm:p-4 animate-in fade-in duration-150 overflow-y-auto"
          onClick={(e) => { if (e.target === e.currentTarget) setSelectedCallDetail(null); }}
        >
          <div 
            className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-2xl sm:rounded-3xl max-w-md w-full p-4 sm:p-6 space-y-6 shadow-2xl relative text-xs text-[#E4E4E7] my-auto max-h-[90vh] overflow-y-auto custom-scrollbar"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between border-b border-[#2C2C2E]/60 pb-3">
              <h2 className="text-base sm:text-lg font-bold text-white tracking-tight">Call Details</h2>
              <div className="flex items-center gap-2 sm:gap-3 text-[#A1A1AA]">
                <button type="button" className="p-1 rounded-lg hover:text-white hover:bg-white/5 transition-colors cursor-pointer" title="Options">
                  <EllipsisHorizontalIcon className="w-5 h-5" />
                </button>
                <button type="button" className="p-1 rounded-lg hover:text-white hover:bg-white/5 transition-colors cursor-pointer" title="Edit">
                  <PencilSquareIcon className="w-4.5 h-4.5" />
                </button>
                <button type="button" onClick={() => setSelectedCallDetail(null)} className="p-1 rounded-lg hover:text-white hover:bg-white/5 transition-colors cursor-pointer" title="Close" aria-label="Close">
                  <XMarkIcon className="w-5 h-5" />
                </button>
              </div>
            </div>
