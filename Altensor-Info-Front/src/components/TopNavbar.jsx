                ...
                >
                  ...
                  <div>
                    <h4 className="font-label-sm text-[11px] uppercase tracking-widest text-primary font-bold mb-4 flex items-center gap-2">
                      ...
                      {t('megaMenu.tasksCategory', {}, 'Tapşırıqlar')}
                    </h4>
                    <ul className="space-y-3.5">
                      <li>
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {t('megaMenu.taskManagement', {}, 'Task Management')}
                            </span>
                            <span className="text-[11px] text-on-surface-variant/70 leading-tight block">
                              {t('megaMenu.taskManagementDesc', {}, 'Çevik tapşırıq və kanban axını')}
                            </span>
                          </div>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          >
                            {t('megaMenu.sprintPlanning', {}, 'Sprint Planlama')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60">
                            {t('megaMenu.sprintPlanningDesc', {}, 'Mərhələlər və hədəf izləmə')}
                          </span>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          >
                            {t('megaMenu.workloadMgmt', {}, 'İş Yükü İdarəsi')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60">
                            {t('megaMenu.workloadMgmtDesc', {}, 'Komanda resurs balanslaşdırma')}
                          </span>
                        </Link>
                      </li>
                    </ul>
                  ...
                  <div>
                    <h4 className="font-label-sm text-[11px] uppercase tracking-widest text-secondary font-bold mb-4 flex items-center gap-2">
                      ...
                      {t('megaMenu.crmCategory', {}, 'Satış & CRM')}
                    </h4>
                    <ul className="space-y-3.5">
                      <li>
                        <Link
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              {t('megaMenu.altensorCrm', {}, 'Altensor CRM')}
                            </span>
                            <span className="text-[11px] text-on-surface-variant/70 leading-tight block">
                              {t('megaMenu.altensorCrmDesc', {}, 'Müştəri və sövdələşmə borusu')}
                            </span>
                          </div>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          >
                            {t('megaMenu.dealsContracts', {}, 'Sövdələşmələr & Müqavilələr')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60">
                            {t('megaMenu.dealsContractsDesc', {}, 'B2B satış mərhələləri')}
                          </span>
                        </Link>
                      </li>
                      <li>
                        ...
                        >
                          ...
                          >
                            {t('megaMenu.orgsContacts', {}, 'Təşkilatlar & Əlaqələr')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60">
                            {t('megaMenu.orgsContactsDesc', {}, 'Vahid korporativ ünvanlar')}
                          </span>
                        </Link>
                      </li>
                    </ul>
                  ...
                  <div>
                    <h4 className="font-label-sm text-[11px] uppercase tracking-widest text-sky-500 font-bold mb-4 flex items-center gap-2">
                      ...
                      {t('megaMenu.aiCategory', {}, 'Süni İntellekt')}
                    </h4>
                    <ul className="space-y-3.5">
                      <li>
                        <div className="p-1.5 rounded-xl">
                          ...
                          >
                            {t('megaMenu.editorialAi', {}, 'Editorial AI')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/70 block">
                            {t('megaMenu.editorialAiDesc', {}, 'Avtomatlaşdırılmış brifinq sintezi')}
                          </span>
                        </div>
                      </li>
                      <li>
                        <div className="p-1.5 rounded-xl">
                          ...
                          >
                            {t('megaMenu.revenueAnalytics', {}, 'Gəlir Analitikası')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60 block">
                            {t('megaMenu.revenueAnalyticsDesc', {}, 'Proqnozlaşdırılan artım modeli')}
                          </span>
                        </div>
                      </li>
                      <li>
                        <div className="p-1.5 rounded-xl">
                          ...
                          >
                            {t('megaMenu.smartSignals', {}, 'Ağıllı Siqnallar')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60 block">
                            {t('megaMenu.smartSignalsDesc', {}, 'Yüksək prioritetli tələblər')}
                          </span>
                        </div>
                      </li>
                    </ul>
                  ...
                  <div>
                    <h4 className="font-label-sm text-[11px] uppercase tracking-widest text-emerald-500 font-bold mb-4 flex items-center gap-2">
                      ...
                      {t('megaMenu.platformCategory', {}, 'Platforma')}
                    </h4>
                    <ul className="space-y-3.5">
                      <li>
                        <Link
                        ...
                        >
                          ...
                          >
                            {t('megaMenu.desktopWorkspace', {}, 'Desktop / Workspace')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60">
                            {t('megaMenu.desktopWorkspaceDesc', {}, 'Vahid tətbiq mərkəzi')}
                          </span>
                        </Link>
                      </li>
                      <li>
                        <div className="p-1.5 rounded-xl">
                          ...
                          >
                            {t('megaMenu.callLogs', {}, 'Zəng Tarixçəsi')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60 block">
                            {t('megaMenu.callLogsDesc', {}, 'Danışıq qeydiyyatı')}
                          </span>
                        </div>
                      </li>
                      <li>
                        <div className="p-1.5 rounded-xl">
                          ...
                          >
                            {t('megaMenu.notifications', {}, 'Bildirişlər')}
                          </span>
                          <span className="text-[11px] text-on-surface-variant/60 block">
                            {t('megaMenu.notificationsDesc', {}, 'Mərkəzi siqnal axını')}
                          </span>
                        </div>
                      </li>
                    </ul>
                ...
                <div className="pt-4 flex items-center justify-between text-xs text-on-surface-variant/80">
                  <div className="flex items-center gap-6">
                    <span className="flex items-center gap-1.5 text-emerald-500 font-medium">
                      <span className="w-2 h-2 rounded-full bg-emerald-500"></span> {t('megaMenu.uptime', {}, '99.9% Uptime')}
                    </span>
                    <span className="flex items-center gap-1.5">
                      <span className="material-symbols-outlined text-sm text-primary">security</span> {t('megaMenu.enterpriseSecurity', {}, 'Enterprise Təhlükəsizlik')}
                    </span>
                  </div>
                  <Link
                    to={startDestination}
                  ...
                  >
                    {t('megaMenu.allApps', {}, 'Bütün Tətbiqlərə Keçid')} →
                  </Link>
                </div>
              </div>
            )}
